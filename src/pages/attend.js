              ...
              <div class="description grid">
                <div class="grid-half-first">
                  <p>
                    ...
                    home for both the daily sessions and primary accomodations.
                    It features 2 restaurants, 2 outdoor pools, an oceanarium,
                    and a fitness center!
                  </p>
                  <p>
                    Attendees for the conference will recieve a special room
                    rate, however, we have limited availability and you MUST use
                    the link below to book and receive the special rate.
                  </p>
                  <ul>
              ...
              <div className="description grid">
                <div className="grid-full-about">
                  ...
                  <p>
                    ...
                    For our second year, we're planning to bring about 400
                    people together for a three-day single track conference. Our
                    goal is that by the time you leave, you'll have seen some
                    new ideas, learned some more JavaScript, and made new
                    friends to keep in touch with.
                  </p>
                  <h4>Being at the conference</h4>
                  <p>
                    The small, single-track nature of the conference means that
                    it's easy to figure out what to do! We'll have lots of time
                    to meet your fellow attendees and share ideas outside of the
                    sessions.
                  </p>
                  <h4>Schedule</h4>
                  <p>
                  ...
                  <p>
                    ...
                    the late-evening along with a casual meetup for you to meet
                    your fellow attendees as they arrive.
                  </p>
                  <p>
                    ...
                    hour-long break for lunch in the middle; plenty of time to
                  ...
                  <p>
                    ...
                    you'll have a chance to vote for your preferred activity
                    when you buy your ticket! We'll announce the final
                    activities as the conferences draws nearer.
                  </p>
                  <h4>Amenities</h4>
                  <p>
                  ...
                  <p>
                    ...
                    you room will be just an elevator ride away should you need
                    to step out and take a break. In addition, we'll have the
                    theater area sectioned off from our "lounge" area, so if you
                    need snacks, coffee, or just want to meet up with a friend,
                    we'll have space for that.
                  </p>
                  <p>
                ...
                <div className="description grid">
                  <div className="grid-half-first">
                    ...
                    <p>
                      ...
                      from almost any hub airport in the US, and several in
                      Asia.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      hotel and meeting room venue. The beach is just across the
                      street from our hotel. Our evening party may be a short
                      walk away in Waikiki, but if it's further than that we'll
                      provide shuttles. So plan to not need any transportation
                      if you are staying with us at the Alohilani
                    </p>
                    <p>
                      As there's so much to see around Hawaiʻi, it's worth
                      noting that if you choose to arrive early or stay later,
                      there's two rental car companies available on-premises, so
                      you can easily grab a car after or return yours before the
                      conference.
                    </p>
                    <p>
