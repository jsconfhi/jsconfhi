...
const IndexPage = () => (
  <div>
    ...
    <Container>
      ...
      <Section>
        <H2>Sponsorships</H2>
        <p>We are currently offering <a href="/sponsors">sponsorship</a> packages for the inauguaral JSConf Hawaii coming
        ...
        <p><a href="mailto:sponsor@jsconfhi.com">Contact us</a> to learn more about our available packages!</p>
      </Section>
      <Section>
        <H2>Code of Conduct</H2>
        <p>All attendees, speakers, sponsors and volunteers at our conference are required to agree with the following
           code of conduct. <a href="http://jsconf.com/codeofconduct.html" target="_blank">Read the Code of Conduct</a>.
        </p>
      </Section>
    </Container>
  </div>
