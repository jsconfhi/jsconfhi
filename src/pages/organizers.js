          ...
          <div className="grid-full">
            ...
            <div className="grid-third-2-3">
              <div className="organizer">
                <img className="avatar" src="/img/charlie.jpg" alt="Charlie" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/jade.jpg" alt="Jade" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/kng.jpg" alt="Kelly" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/jkup.jpg" alt="Jon" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/tracy.jpg" alt="Tracy" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/jason.jpg" alt="Jason" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/ed.jpg" alt="Ed" />
              ...
              <div className="organizer">
                <img className="avatar" src="../img/jenn.png" alt="Jenn" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/romina.jpg" alt="Romina" />
              ...
              <div className="organizer">
                <img className="avatar" src="/img/myles.jpg" alt="Myles" />
