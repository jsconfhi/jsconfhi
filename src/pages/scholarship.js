            ...
            <div class="description grid">
              <div class="grid-half-first">
                ...
                <p>
                  ...
                  those perspectives, so we offer an Opportunity Scholarship for
                  members of those groups who might not be able to attend
                  otherwise.
                </p>
            ...
            <div className="grid">
              <div className="grid-half-first">
                <blockquote class="twitter-tweet">
                  <p lang="en" dir="ltr">
                    Friends, this is how I had the amazing experience of mashing
                    JavaScript and Hawai’i earlier this year. 😱Very grateful
            ...
            <div className="description grid">
              <div className="grid-full-about">
                ...
                <p>
                  ...
                  increase the diversity of perspectives at the conference. Our
                  primary method is to subsidize members of communities that are
                  traditionally underrepresented in tech, and who wouldn't be
                  able to attend without financial assistance.
                </p>
                <p>Underrepresented groups include (but are not limited to):</p>
                <ul>
                ...
                <p>
                  The group identification portion of the application is a text
                  field. If you are a part of an underrepresented group we have
                  not identified, please feel free to apply and list it!
                </p>
                <h4>How Much Work is the Application Process?</h4>
                <p>
                  We have streamlined the application process compared to
                  JSConfHI 2019. This year are only asking for demographic data,
                  what you need, and two fields asking what you hope to get out
                  of the conference, and how you are currently involved in the
                  tech community. We recommend 200-500 words for the two
                  question sections so we can learn about you and how to best
                  meet your needs!
                </p>
                <h4>When Will I Find Out If I Got the Scholarship?</h4>
                <p>
                  The JSConfHI team is aiming to announce scholarship recepients
                  in mid-November. We have a policy of informing both those who
                  received the scholarship and those who didn't, so no one is
                  left wondering.
                </p>
                <h4>
                ...
                <p>
                  ...
                  much as we can, but it's likely we'll have more requests than
                  we can fulfill.
                </p>
                <p>
                  ...
                  . However, if you are selected for a scholarship, you will be
                  reimbursed for the expenses you would have had covered as a
                ...
                <p>
                  There are four main ways to help JSConfHI with our Opportunity
                  Scholarship mission:
                </p>
                <ul>
                  <li>
                  ...
                  <li>
                    Spread the word about Opportunity Scholarships to those who
                    could use it!
                  </li>
                </ul>
              </div>
