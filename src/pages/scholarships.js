                ...
                <div className="description grid">
                  <div className="grid-half-first">
                    ...
                    <p>
                      ...
                      resources for a conference in Hawai'i. We don't want to
                      lose those perspectives, so we offer an Opportunity
                      Scholarship for members of those groups who might not be
                    ...
                    <p>
                      <strong>Applications are now closed.</strong> All
                      applicants have been notified of their status. If you
                      applied and have not heard back, please email us at{" "}
                      <a href="mailto:scholarships@jsconfhi.com">
                        scholarships@jsconfhi.com
                      </a>
                      !
                    </p>
                  </div>
                ...
                <div className="description grid">
                  <div className="grid-full-about">
                    ...
                    <p>
                      ...
                      be reimbursed for the expenses you would have had covered
                      as a scholarship recepient.
                    </p>
                    <p>
                      <a
                    ...
                    <p>
                      <a
                        ...
                        className="button-primary button-tweet"
                      >
